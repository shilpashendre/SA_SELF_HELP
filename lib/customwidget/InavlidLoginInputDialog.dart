...
class InavlidLoginInputDialog extends StatefulWidget {
  ...
  _InavlidLoginInputDialogtState createState() =>
      _InavlidLoginInputDialogtState();
}

class _InavlidLoginInputDialogtState extends State<InavlidLoginInputDialog> {
  String inValidLoginDialogMsg =
      "SA ID or Contact Number you entered is incorrect, please try again";
  @override
